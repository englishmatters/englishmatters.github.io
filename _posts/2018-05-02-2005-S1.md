...
- **even if** <br> 1. despite the possibility that; no matter whether: <br>  - *Always try everything even if it turns out to be a dud.* <br> <blockquote>**dud** /dʌd/ n. [*informal*] a thing that fails to work properly or is otherwise unsatisfactory or worthless</blockquote> <br>  - *It is a unique gift that once given will always remain, even if the relationship ends.* <br> 2. despite the fact that; **even though**: <br>  - *He is a great President, even if he has many enemies.* <br>  - *My mother always did her best for me, even if there wasn't always enough to go around.* <br> <blockquote>**go round** (*US* **go around**) (esp. of food) be sufficient to supply everybody present</blockquote> <br>  - *Evolution is still a theory even though it is now taught in state schools as hard facts.* <br>  - *MPs are widely thought to be corrupt even though the vast majority of them are anything but.*
